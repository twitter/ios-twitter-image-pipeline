...
FOUNDATION_EXTERN NSArray<NSString *> * __nullable TIPContentsAtPath(NSString *dirPath, NSError * __nullable * __nullable outError);
 ...
 */
FOUNDATION_EXTERN NSDictionary<NSString *, id> * __nullable TIPGetXAttributesForFile(NSString *filePath, NSDictionary<NSString *, Class> *keyKindMap);
 ...
 */
FOUNDATION_EXTERN NSUInteger TIPSetXAttributesForFile(NSDictionary<NSString *, id> *xattrs, NSString *filePath);
...
FOUNDATION_EXTERN int TIPSetXAttributeNumberForFile(const char *name, NSNumber *number, const char *filePath);
//! Set _string_ as the attribute with the given _name_ for _filePath_
FOUNDATION_EXTERN int TIPSetXAttributeStringForFile(const char *name, NSString *string, const char *filePath);
//! Set _date_ as the attribute with the given _name_ for _filePath_
FOUNDATION_EXTERN int TIPSetXAttributeDateForFile(const char *name, NSDate *date, const char *filePath);
//! Set _url_ as the attribute with the given _name_ for _filePath_
FOUNDATION_EXTERN int TIPSetXAttributeURLForFile(const char *name, NSURL *url, const char *filePath);

//! Return the `NSString` for the attribute with the given _name_ for _filePath_ (or `nil`)
FOUNDATION_EXTERN NSString * __nullable TIPGetXAttributeStringFromFile(const char *name, const char *filePath);
//! Return the `NSNumber` for the attribute with the given _name_ for _filePath_ (or `nil`)
FOUNDATION_EXTERN NSNumber * __nullable TIPGetXAttributeNumberFromFile(const char *name, const char *filePath);
//! Return the `NSDate` for the attribute with the given _name_ for _filePath_ (or `nil`)
FOUNDATION_EXTERN NSDate * __nullable TIPGetXAttributeDateFromFile(const char *name, const char *filePath);
//! Return the `NSURL` for the attribute with the given _name_ for _filePath_ (or `nil`)
FOUNDATION_EXTERN NSURL * __nullable TIPGetXAttributeURLFromFile(const char *name, const char *filePath);
